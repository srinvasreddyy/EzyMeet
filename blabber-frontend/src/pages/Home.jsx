    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow flex items-center justify-center">
        <main className="flex flex-col items-center px-4 text-center">
          ...
          <img src={chromeWebStore} alt="Available on Chrome Web Store" className="w-1/6 mx-auto" />          {/* EzyMeet logo */}
          <h1 className="text-9xl mb-4 superlarge logo-bg">EzyMeet</h1>
          <div className="container mx-auto w-2/3">
            <h2 className="text-2xl font-semibold mb-4">
              Generate custom meeting recaps, reports, and transcripts using AI
            </h2>
            <p className="mb-4">
              Use EzyMeet, a <u>Chrome extension</u>, to generate meeting recaps, reports, and transcripts for your meetings, interviews, and other conversations.
            </p>
